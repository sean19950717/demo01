package com.demo.orm.plugins;

import com.demo.common.entity.Page;
import com.demo.common.utils.PaginationCacheUtils;
import com.demo.orm.dialect.Dialect;
import com.demo.orm.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor {
    ...
    private int getTotal(ParameterHandler parameterHandler, Connection connection, String countSql) throws Exception {
        int countSqlHash=countSql.hashCode();
        countSqlHash=(countSql+countSqlHash).hashCode();
        if (PaginationCacheUtils.getPaginationCache(countSqlHash+"")!=null){
            return  Integer.parseInt(PaginationCacheUtils.getPaginationCache(countSqlHash+""));
        }
        ...
        PaginationCacheUtils.savePaginationCache(countSqlHash+"",count+"");
        return count;
    }
}
